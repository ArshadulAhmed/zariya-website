...
const DashboardHome = memo(() => {
  ...
  const statsArray = [
    ...
    {
      title: 'Fine to Recover',
      value: stats.fineRecoverable
        ? formatExactIndianCurrency(stats.fineRecoverable.value)
        : '₹0.00',
      trend: stats.fineRecoverable?.trend || 'neutral',
      trendValue: stats.fineRecoverable?.trendValue || 'From daily snapshot',
      color: 'danger',
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
