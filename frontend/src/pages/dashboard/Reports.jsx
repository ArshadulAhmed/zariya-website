    ...
    <div className="reports-page">
      ...
      <div className="reports-grid">
        ...
        <div className="report-card">
          ...
          <h3 className="report-title">Individual Loan Report</h3>
        ...
        <div className="report-card">
          ...
          <h3 className="report-title">Daily Collection Report</h3>
          <p className="report-description">View loan collections and repayment information for a specific date</p>
          <button 
            className="report-btn"
            onClick={() => navigate('/dashboard/reports/daily-collection')}
          >
            Generate Report
          </button>
        </div>
