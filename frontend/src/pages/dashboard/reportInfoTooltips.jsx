...
export const OUTSTANDING_INFO =
  'Loans with remaining principal or unpaid fine (any status). On-time loans with a remaining balance appear here. Closed loans with unpaid fine appear when Status is All. Active loans with remaining ₹0 and fine ₹0 but pending tenure EMIs appear only in Loans Not Repaid Up To Date.'
